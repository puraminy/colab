...
EXP = "natural_10000_2020"
TRAIN_FILE = EXP + "_train.tsv"
DEV_FILE = "natural_1000_atomic_dev.tsv"
...
# First import the t5 mixtures so we can load the training mixture's vocabulary.
    ...
    question_1 = "PersonX brings ___ to the people. PersonX is"
    question_2 = "PersonX starves the ___ into submission. As a result, others feel"
    question_3 = "PersonX starves the ___ into submission. PersonX did this to"
